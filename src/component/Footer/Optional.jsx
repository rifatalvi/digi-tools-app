...
const Optional = () => {
    return (
        <div className='bg-linear-to-r  from-[#4F39F6] to-[#9514FA] p-15 text-center text-white space-y-6'>
            ...
            <div>
                <button className='btn bg-white text-[#9514FA] mr-3 rounded-full'>Explore Products</button>
                <button className='btn bg-transparent text-white rounded-full'>View Pricing</button>
